...
HD_PWD='/archive/scripts/ECE3570Lab2/ECE3570Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU10Bits_Pipelined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU10Bits_Pipelined.tcl -notrace
